...
export default function CompanyEdit({loaderData, actionData}: Route.ComponentProps) {
  return (
    <div>
        <CompanyForm isEditing={true} actionData={actionData} company={loaderData.company}></CompanyForm>
    </div>
  );
}
