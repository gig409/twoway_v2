...
const FormSchema = z.object({
    ...
    company_add1: z.string().min(2, "Must be min 2 chars").max(100, "Must be max 100 chars"),
    company_add2: z.string().max(100, "Must be max 100 chars").optional(),
    country: z.string("Must be a string").min(2, "Must be min 2 chars").max(100, "Must be max 100 chars"),
    company_city: z.string().min(2, "Must be min 2 chars").max(100, "Must be max 100 chars"),
    company_post_code: z.string().min(2, "Must be min 2 chars").max(20, "Must be max 20 chars"),
});
